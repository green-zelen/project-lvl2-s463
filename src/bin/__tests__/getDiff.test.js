...
test('compare two jsons/json', () => {
  expect(renderJson(getSortedAst(jsonBefore1, jsonAfter1))).toBe(fs.readFileSync(`${__dirname}/__fixtures__/__txt__/1expect.json`, 'utf-8'));
});
...
test('compare two yamls/json', () => {
  expect(renderJson(getSortedAst(yamlBefore2, yamlAfter2))).toBe(fs.readFileSync(`${__dirname}/__fixtures__/__txt__/2expect.json`, 'utf-8'));
});
...
test('compare two inies/json', () => {
  expect(renderJson(getSortedAst(iniBefore3, iniAfter3))).toBe(fs.readFileSync(`${__dirname}/__fixtures__/__txt__/3expect.json`, 'utf-8'));
});
...
test('compare two inline jsons/json', () => {
  expect(renderJson(getSortedAst(jsonBefore4, jsonAfter4))).toBe(fs.readFileSync(`${__dirname}/__fixtures__/__txt__/4expect.json`, 'utf-8'));
});
...
test('compare two inline  yamls/json', () => {
  expect(renderJson(getSortedAst(yamlBefore5, yamlAfter5))).toBe(fs.readFileSync(`${__dirname}/__fixtures__/__txt__/5expect.json`, 'utf-8'));
});
...
test('compare two inline inies/json', () => {
  expect(renderJson(getSortedAst(iniBefore6, iniAfter6))).toBe(fs.readFileSync(`${__dirname}/__fixtures__/__txt__/6expect.json`, 'utf-8'));
});
