...
//    expect(getDiff(yamlBefore3, yamlAfter3))
//    .toEqual(readFile(`${__dirname}/__fixtures__/__txt__/3expect.yml`));
// });

// test('compare two first inies', () => {
//   expect(getDiff(iniBefore4, iniAfter4))
//   .toEqual(readFile(`${__dirname}/__fixtures__/__txt__/4expect.ini`));
// });

// test('compare two nested jsons', () => {
//   expect(getDiff(jsonBefore5, jsonAfter5))
//   .toEqual(readFile(`${__dirname}/__fixtures__/__txt__/5expect.json`));
// });

// test('compare two short nested jsons', () => {
//   expect(getDiff(jsonBefore6, jsonAfter6))
//   .toEqual(readFile(`${__dirname}/__fixtures__/__txt__/6expect.json`));
// });

// test('compare two nested yamls', () => {
//   expect(getDiff(yamlBefore7, yamlAfter7))
//   .toEqual(readFile(`${__dirname}/__fixtures__/__txt__/7expect.yml`));
// });

// test('compare two nested inies', () => {
//   expect(getDiff(iniBefore8, iniAfter8))
//   .toEqual(readFile(`${__dirname}/__fixtures__/__txt__/8expect.ini`));
// });
