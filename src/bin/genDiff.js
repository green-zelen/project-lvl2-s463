...
export function getDiff(before, after, render) {
  ...
  const reducerForBefore = (accBefore, el) => ({
    ...accBefore,
    [`- ${el}`]: before[el],
  });
  return render(deleteKeys.reduce(reducerForBefore, extraacc));
}
